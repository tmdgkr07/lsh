...
def hourly(weather):
    ...
    weather_hourly  = '시간별 온도 ' + temperature_tc + ', 최고 ' + temperature_tmax + ', 최저 ' + temperature_tmin + ', 하늘 ' + sky_name + ', 바람 ' + wind_wspd + ', 습도' + humidity
...
def minutely(weather):
    ...
    weather_minutely = '분별 온도 ' + temperature_tc + ', 최고 ' + temperature_tmax + ', 최저 ' + temperature_tmin + ', 하늘 ' + sky_name + ', 바람 ' + wind_wspd + ', 습도' + humidity
    print(weather_minutely)
